...
#     # post ➡ user 필드에서 CustomUser 모델의 nickname을 표시하기 위한 메소드
...
#         return obj.user if obj.user else 'Unknown'
...
#     user_username.short_description = '유저'
#     post_created_at.short_description = '등록일자'
#     post_updated_at.short_description = '수정일자'
...
# 출력 필드 설정
    list_display = ('is_public', 'post_title', 'user_username', 'user_nickname',
                    'post_created_at', 'post_updated_at', 'comment_count'
                    )
    # 읽기 전용 필드 설정
    readonly_fields = ('created_at', 'updated_at')
